            ...
            >
              <CCol sm={10}>
                <h5 id="traffic" className="card-title mb-0">
                  Anitra Cluster Entrepreneurs List
                </h5>
              </CCol>
              <CCol sm={10} style={{ marginTop: '10px' }}>
                <h6 id="traffic" className="card-title mb-0">
                  Partners {'>'} Anitra Cluster Entrepreneurs
                </h6>
              </CCol>
            </div>
          </CCol>
              ...
              <CTable align="middle" className="mb-0 border" hover responsive>
                <CTableHead color="light">
                  <CTableRow>
                    ...
                    <CTableHeaderCell>SV Name</CTableHeaderCell>
                    <CTableHeaderCell className="text-center">Farmer</CTableHeaderCell>
                    <CTableHeaderCell className="text-center">Trader</CTableHeaderCell>
                    <CTableHeaderCell className="text-center">Animals</CTableHeaderCell>
                    <CTableHeaderCell>Villages</CTableHeaderCell>
...
export default AnitraClusterList
