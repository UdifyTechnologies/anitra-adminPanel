    ...
    <>
              ...
              <CTable align="middle" className="mb-0 border" hover responsive>
                <CTableHead color="light">
                  <CTableRow>
                    ...
                    <CTableHeaderCell className="text-center">Village</CTableHeaderCell>
                    <CTableHeaderCell className="text-center">Existing VE</CTableHeaderCell>
      ...
      <CCard>
        <CCardBody>
          ...
          <CRow>
            <CChartLine
              style={{ width: '550px', height: '300px', marginTop: '40px' }}
              data={{
